...
pub fn msg_name(msg: &onlinerpg_shared::ServerMessage) -> &'static str {
    ...
    match msg {
        ...
        ServerMessage::TeleportGateState { .. } => "TeleportGateState",
        ServerMessage::TeleportGateTravelled { .. } => "TeleportGateTravelled",
        ServerMessage::TeleportGateError { .. } => "TeleportGateError",
        ServerMessage::GuardUpdated { .. } => "GuardUpdated",
        ServerMessage::EquipmentBurdenUpdated { .. } => "EquipmentBurdenUpdated",
