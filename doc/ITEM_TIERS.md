...
2. 신규 애셋: leather_belt 아이콘(현재 sword.png placeholder로 드랍 중), 판금 파츠 2종(plate_helmet·plate_gauntlets), 기본 망토, 특수 망토, 셔츠, 장신구 아이콘 3종(protection·life_saving·regeneration) (Meshy/ChatGPT 생성, `doc/assets/items.md`에 기록). leather_gloves·leather_boots·iron_helmet·iron_gauntlets는 완료 (2026-07-31), chain_mail·plate_greaves는 완료 (2026-08-01), plate_boots는 완료 (2026-08-02).
