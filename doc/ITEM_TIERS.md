...
효과 장신구는 NetHack 계열로 간다 (효과 수치는 구현 시 확정). gold_ring은 CHA +1(ring of adornment 계열)로 전환 — 흥정 밴드 ±2%p, 반지 2슬롯 중첩 허용(캡 안). 구 체스트 규칙 유통분 77개는 소급 적용. 무효과로 남는 silver_necklace는 신규 획득 경로 없음; 치장 수요가 확인되어 추후 상점 사치품(성능 0, 골드 싱크)化 검토.

| 아이템 | 효과 | 획득처 | 상태 |
|--------|------|--------|------|
| ring_of_protection | guard +1 | 티어 5 던전 (20% 롤) | 있음 |
| gold_ring | CHA +1 | 티어 3 던전 (10% 롤) | 있음 (티어 3 던전 대기) |
